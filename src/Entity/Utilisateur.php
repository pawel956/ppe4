 ...
 * Utilisateur
 *
 * @ORM\Table(name="utilisateur", indexes={@ORM\Index(name="id_genre", columns={"id_genre"}), @ORM\Index(name="id_statut", columns={"id_statut"}), @ORM\Index(name="id_image", columns={"id_image"})})
